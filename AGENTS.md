...
Personal brand and consulting site for **Mark Fasel**, Solutions Architect & AI Strategist. This is the canonical context file for Codex. Read this before every task.
...
- **Opsly and TrustLaunch are Coming soon.** Neither has an implementation repository. Do not publish a case study, stack, or “built” claim until implementation exists. `content/projects/opsly.mdx` remains a draft architecture note.
- **Products is out of the nav entirely** until a product actually exists.
