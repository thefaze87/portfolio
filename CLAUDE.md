...
> **The single most important rule:** This is not a designer portfolio, freelancer portfolio, architecture firm site, or SaaS landing page. It is the digital headquarters of a working solutions architect with 20+ years of experience. When in doubt, choose the option that reads as a *publication* rather than a *product*.
...
- ✅ A working portfolio of *systems thinking*, not "projects"
...
The MF monogram uses **shared-stem geometric construction**: the right leg of the M *is* the left spine of the F. Strokes are square-cap, monoline.
