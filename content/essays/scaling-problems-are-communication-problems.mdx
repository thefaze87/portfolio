...
The same move works at the level of systems rather than teams. When [two systems of record disagreed about the same transactions](/projects/aviation-financial-integration), no amount of synchronization logic fixed it; assigning each field exactly one owner did, because conflicts require two writers.
