...
The likely build is the pattern that has already proven itself on [Helixon](/projects/helixon): a monolithic repository with a clear admin and API layer separation, PostgreSQL, and background jobs as first-class infrastructure.
