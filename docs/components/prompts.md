...
> **Before starting each phase:** confirm in chat with Claude Code by asking *"Have you read CLAUDE.md and PLAN.md?"* If it hasn't, instruct it to read both before doing anything.
